 ...
 * @property {number} r The extent of the particle
 * 
 ...
 * 
 * @property {p5.Image} texture The texture of the particle. It is used for visualization purposes within a p5.js canvas
 */
 export default class Particle {
    /**
     * @param {p5.Vector} pos The 2D position of the particle
     * @param {p5.Image} texture The texture of the particle
     * 
     * @param {p5} _p5 An instance of p5.js
     */
    constructor(pos, texture, _p5 = p5.instance) {
        this.p5 = _p5;

        this.mass = 4;
        this.r = 2*this.mass;

        const v_x = 0.3*_p5.randomGaussian();
        const v_y = 0.3*_p5.randomGaussian() - 1;

        this.pos = pos.copy();
        this.vel = _p5.createVector(v_x, v_y);
    ...
    display() {
        ...
        _p5.push();            
            ...
            _p5.tint(255, this.lifespan);
            _p5.image(this.texture, 
                      this.pos.x, 
                      this.pos.y);
        _p5.pop();
    }
